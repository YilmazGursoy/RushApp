...
//  RushApp
//
//  Created by Yilmaz Gursoy on 18.09.2018.
...
public final class AddCommentMutation: GraphQLMutation {
    ...
    public var variables: GraphQLMap? {
        return ["baseId": baseId, "createdAt": createdAt, "message": message, "senderUserId": senderUserId, "senderUserName": senderUserName]
    }
    ...
    public struct Data: GraphQLSelectionSet {
        ...
        public static let selections: [GraphQLSelection] = [
            GraphQLField("addComment", arguments: ["baseId": GraphQLVariable("baseId"), "createdAt": GraphQLVariable("createdAt"), "message": GraphQLVariable("message"), "senderUserId": GraphQLVariable("senderUserId"), "senderUserName": GraphQLVariable("senderUserName")], type: .object(AddComment.selections)),
            ]
